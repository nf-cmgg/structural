...
def main(argv):
    parser = argparse.ArgumentParser(
        description=__doc__, prog="svtest sr-file", formatter_class=argparse.RawDescriptionHelpFormatter
    )
...
def get_metrics(sr_file, sample_list):
    ...
    return {LEFT_KEY + metric_suffix: side_metrics[0], RIGHT_KEY + metric_suffix: side_metrics[1]}

...
workflow BAM_VARIANT_CALLING_DELLY {
    ...
    // Scattering is disabled for now. We have to investigate whether it is really necesarry.
    // It can be an issue for calling translocations and bigger variants
    ...
    ch_crams
        .join(ch_beds.map{ meta, bed, bed_gz, bed_gz_tbi -> [ meta, bed ] }, failOnDuplicate:true, failOnMismatch:true)
